...
*/
/************************************************************************/
int CoordTransform::WorldtoMap(PosPoint org, double xIn, double yIn, double &xOut, double &yOut)
{
...
//转换局部坐标到全局世界坐标
int CoordTransform::MaptoWorld(PosPoint org, double xIn, double yIn, double &xOut, double &yOut)
{
	double dx = 0, dy = 0, dstX = 0, dstY = 0;
